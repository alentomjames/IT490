...
$root = "/home/{$user}/git/IT490";
$directories = [
    "/home/{$user}/git/IT490/loginBundle",
    "/home/{$user}/git/IT490/loginBundleDB",
    "/home/{$user}/git/IT490/moviesDB",
    "/home/{$user}/git/IT490/pagesBundle",
    "/home/{$user}/git/IT490/dmzBundle",
    "/home/{$user}/git/IT490/backendBundle",
    "/home/{$user}/git/IT490/jsonBundle",
...
while (true) {
    ...
    if ($events) {
        foreach ($events as $event) {
            ...
            // Make the file path
            $relativePath = str_replace("/home/{$user}}/git/IT490", '', $filePath);
